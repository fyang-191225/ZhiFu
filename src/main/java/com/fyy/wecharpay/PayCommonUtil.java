package com.fyy.wecharpay;

import com.fyy.wecharpay.util.HttpUtil;
import com.fyy.wecharpay.util.MD5Util;
import com.fyy.wecharpay.util.XmlUtil;
...
public class PayCommonUtil {
    ...
    public static String weixin_cancel(String oid){
        ...
        packageParams.put("sign", sign);
        String requestXML = PayCommonUtil.getRequestXml(packageParams);
        String resXml = HttpUtil.postData(PayConfig.CANCEL_URL, requestXML);
        return resXml;
    }
}
